    ...
    <>
      ...
      <main className="mx-auto max-w-5xl px-5 py-12">
        <div className="max-w-2xl">
          ...
          {step === "home" && (
            <>
              <h1 ref={heading} tabIndex={-1} className="mt-2 text-4xl font-bold tracking-tight focus:outline-none">거짓말탐지기 예약</h1>
              <p className="mt-2 text-neutral-500">참여할 섹션을 선택하고 예약 정보를 입력해 주세요.</p>
              <p className="mt-6 rounded-lg border border-neutral-200 bg-neutral-50 p-4 text-sm text-neutral-600">예약 화면 준비 중입니다. 지금은 실제 예약이 접수되지 않습니다.</p>
          ...
          {step === "sections" && (
            <>
              <h1 ref={heading} tabIndex={-1} className="mt-3 text-3xl font-bold tracking-tight focus:outline-none">섹션 선택</h1>
          ...
          {step === "form" && (
            <>
              <h1 ref={heading} tabIndex={-1} className="mt-3 text-3xl font-bold tracking-tight focus:outline-none">{sections[section].title} 예약</h1>
